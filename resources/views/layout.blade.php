...
<body ng-app="sentimentAnalysis">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar style-1" style="padding-top: 20px;">
		<ul class="nav menu">
            ...
            <li class="<?php if (Request::is('dashboard/tokenizing')) echo 'active'; ?>"><a href="{{ URL::to('dashboard/tokenizing') }}"><svg class="glyph stroked chain"><use xlink:href="#stroked-chain"/></svg>Process Token</a></li>
			...
			<li class="<?php if (Request::is('dashboard/idf')) echo 'active'; ?>"><a href="{{ URL::to('dashboard/idf') }}"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad"/></svg> TF-DF-IDF</a></li>
            ...
            <li class="<?php if (Request::is('dashboard/evaluation-rocchio')) echo 'active'; ?>"><a href="{{ URL::to('dashboard/evaluation-rocchio') }}"><svg class="glyph stroked dashboard dial"><use xlink:href="#stroked-dashboard-dial"/></svg> Rocchio Evaluation</a></li>
