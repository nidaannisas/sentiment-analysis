...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Naive Bayes Bernoulli Evaluation</li>
		</ol>
	</div><!--/.row-->
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                <div class="panel-body">
					<div class="panel-heading">Naive Bayes Bernoulli Evaluation</div>
                    <div class="col-md-6">
						<h3>Evaluation</h3>
						<p>Tambahkan note untuk evaluasi yang akan dilakukan.</p>
					</div>
					<div class="col-md-6" style="padding-bottom: 20px;">
						<form role="form" action="{{ URL::to('dashboard/evaluation/evaluateBernoulli') }} " method="post" style="padding-top : 20px;">
