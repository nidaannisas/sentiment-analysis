...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Remove Duplicate</li>
		</ol>
	</div><!--/.row-->
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="col-md-6" style="padding-bottom: 20px;">
						...
						<p>Proses untuk menghilangkan duplikat dengan kemiripan tertentu.</p>
						<form role="form" action="{{ URL::to('dashboard/remove-duplicate/remove') }} " method="post" style="padding-top : 20px;">	
